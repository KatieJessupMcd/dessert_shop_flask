...
class DessertListTests(TestCase):
    ...
    def test_repr(self):
        ...
        self.sample_list.add("Chocolate chip cookie", "C is for cookie, that's good enough for me", 20)
    ...
    def test_add(self):
        ...
        self.assertEqual("Chocolate chip cookie", self.sample_list.desserts[0].name)   
        self.assertEqual("C is for cookie, that's good enough for me", self.sample_list.desserts[0].description)   
    ...
    def test_serialize(self):
        ...
        self.sample_list.add("Chocolate chip cookie", "C is for cookie, that's good enough for me", 20)
        self.assertEqual(self.sample_list.serialize()[0]['id'], self.sample_list.desserts[0].id)   
        self.assertEqual(self.sample_list.serialize()[0]['name'], self.sample_list.desserts[0].name)   
        self.assertEqual(self.sample_list.serialize()[0]['description'], self.sample_list.desserts[0].description)   
        self.assertEqual(self.sample_list.serialize()[0]['calories'], self.sample_list.desserts[0].calories)   
